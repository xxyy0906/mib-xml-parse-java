...
from .gen_itms import write_itms_entities
...
def parse_mib_xml(
    ...
    *,
    ...
    """Generic: any mib-xml → slim xml + Java entities. ITMS Java is opt-in."""
    ...
    if gen_itms:
        write_itms_entities(slim_root, itms_dir)
    else:
        itms_dir = None
